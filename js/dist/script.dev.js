...
function showPage(list, page) {
  ...
  for (var _i = 0; _i < list.length; _i++) {
    ...
    if (_i >= startIndex && _i < endIndex) {
      ...
      var studentItem = "<li class = \"student-item cf\"> \n      <div class = \"student-details\"> \n     <img class=\"avatar\" src=\"".concat(pickPerson.picture.large, "\" alt=\"Profile Picture\">\n     <h3>").concat(pickPerson.name.first, " ").concat(pickPerson.name.last, "</h3>  <span class=\"email\">").concat(pickPerson.email, "</span>\n      </div>\n       <div class=\"joined-details\">\n      <span class=\"date\">").concat(pickPerson.registered.date, "</span>\n    </div>\n      </li> "); // insert the above elements
...
function addPagination(list) {
  ...
  for (var _i2 = 1; _i2 <= numOfPages; _i2++) {
    ...
    var button = "<li>\n  <button type=\"button\">".concat(_i2, "</button>\n</li>");
